...
# 30 "main.c"
void test1(){ printf("%s", (char*)"This is test 1\n"); };

void test2(){ printf("%s", (char*)"This is test 2\n"); };

void test3(){ printf("%s", (char*)"This is test 1\n"); };

void test4(){ printf("%s", (char*)"This is test 2\n"); };
